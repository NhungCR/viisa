...
<br /><br />
<small><?php echo __( 'e.g.', 'wp-datepicker').' '.__('Should disable the months July and December?', 'wp-datepicker').'<br /><pre><br />function (date) { <br />var month = date.getMonth(); <br />return [(month != 6) && (month != 11)]; <br />}<br /><br /></pre><br />'.__('It will disable every Sunday & Monday each month.', 'wp-datepicker').'<br />'.__('Note: It will override weekends functionality.', 'wp-datepicker' ); ?></small><br />
</div>
</div>
<?php } ?>
