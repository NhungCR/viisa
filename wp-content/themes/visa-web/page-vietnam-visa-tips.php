...
<div class="page-content">
    <div class="visa-tips">
        <div class="container">
            <div class="row">
                <div class="col-9">
                    <h1 class="page-title">Vietnam Visa Tips</h1>
                    <div class="row">
                        <div class="col-6">
                            <a href="#" class="tip-item"><img src="<?php bloginfo('template_url'); ?>/images/Afghanistan.png"> How to get Vietnam visa in Afghanistan</a>
                        </div>
                        <div class="col-6">
                            <a href="#" class="tip-item"><img src="<?php bloginfo('template_url'); ?>/images/Afghanistan.png"> How to get Vietnam visa in Afghanistan</a>
                        </div>
